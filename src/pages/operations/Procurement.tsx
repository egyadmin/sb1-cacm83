    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-700">Manage purchase requests and procurement processes</p>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">PR-2024-001</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Office Supplies</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Administration</td>
